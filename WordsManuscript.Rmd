...
#### Stimuli
```{r read in data}
words.data <- read.csv("~/Documents/Nick-Grad/Neta_Lab/Words/words.summary.csv")
```
There were a total of `r printnum(nrow(words.data))` words. 
