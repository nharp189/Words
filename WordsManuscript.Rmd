...
### Data preprocessing
Trials with a response time slower than 250ms (n = were removed from the data prior to analyses, as well as trials greater than 3 SDs above the mean reaction time averaged across all trials. 
